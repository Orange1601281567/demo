...
<mapper namespace="com.example.demo.${classInfo.className}.dao.${classInfo.className}Dao">

    <resultMap id="${classInfo.className}" type="com.example.demo.${classInfo.className}.domain.${classInfo.className}" >
    ...
    <select id="List" parameterType="java.util.Map" resultMap="${classInfo.className}">
        SELECT <include refid="Base_Column_List" />
        FROM ${classInfo.tableName}
    </select>
